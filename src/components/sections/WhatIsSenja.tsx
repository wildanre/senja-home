  ...
  return (
    <section className="py-20 px-4 bg-white dark:bg-[#1a1a2e]">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-lg md:text-xl leading-relaxed text-senja-brown/90 dark:text-[#d0dce6] space-y-6 mb-12">
          <p>
        ...
        <div className="mb-12">
          ...
          >
            <div className="space-y-6">
              <div className="border-l-4 border-senja-orange dark:border-[#60a5fa] pl-6">
                <h4 className="text-xl md:text-2xl font-semibold mb-3 text-senja-brown dark:text-[#e8f0f7]">
                  1. Fragmented liquidity
                </h4>
                <p className="text-base md:text-lg text-senja-brown/80 dark:text-[#d0dce6]">
