  ...
  return (
    <section id="what-is-senja" className="py-20 px-4">
      <div className="max-w-5xl mx-auto">
        ...
        >
          <p>
            <strong className="text-yellow-300 dark:text-[#60a5fa]">Senja </strong> is a <strong className="text-yellow-300 dark:text-[#60a5fa]">permissionless stablecoin lending and borrowing protocol</strong> built on the Kaia ecosystem. Senja Finance also lives on the LINE Mini DApp, where users can supply collateral from multiple chains via cross-chain messaging, swap collateral seamlessly through DragonSwap, and borrow Kaia-native USDT or other stablecoins across multiple chains, with interest rates that automatically adjust based on utilization and asset risk profiles.
          </p>
          
          <p>
            Senja is supported by decentralized oracles such as the <strong className="text-yellow-300 dark:text-[#60a5fa]">Orakl Network</strong> to ensure reliable and secure price feeds for risk management.
          </p>
        </motion.div>
        ...
        >
          <Accordion 
            title="Problem" 
            titleClassName="text-3xl md:text-4xl text-yellow-300 dark:text-[#60a5fa] font-bold"
          >
            <motion.div 
              className="space-y-6"
              initial={{ opacity: 0 }}
          ...
          >
            ...
            >
              ...
              >
                ...
                <p className="text-base md:text-lg text-white/90 dark:text-[#d0dce6] tracking-tight">
                  Senja uses an <strong className="text-yellow-300 dark:text-[#60a5fa]">isolated pool model</strong>, where each asset and its market risk are contained. This ensures <strong className="text-yellow-300 dark:text-[#60a5fa]">safer cross-chain lending</strong> and allows new assets to be onboarded without affecting the stability of the entire system, while still leveraging <strong className="text-yellow-300 dark:text-[#60a5fa]">LayerZero interoperability</strong> for cross-chain access.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-base md:text-lg text-white/90 dark:text-[#d0dce6] tracking-tight">
                  Senja leverages the <strong className="text-yellow-300 dark:text-[#60a5fa]">LINE Mini DApp</strong> for authentication and wallet management. Users can <strong className="text-yellow-300 dark:text-[#60a5fa]">sign in with LINE or Gmail</strong>, lowering the entry barrier for millions of mainstream users.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-base md:text-lg text-white/90 dark:text-[#d0dce6] tracking-tight">
                  Senja uses <strong className="text-yellow-300 dark:text-[#60a5fa]">decentralized oracle</strong> such as Orakl for real-time pricing. This supports <strong className="text-yellow-300 dark:text-[#60a5fa]">dynamic risk models</strong> and <strong className="text-yellow-300 dark:text-[#60a5fa]">efficient liquidations</strong>, protecting both lenders and borrowers.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-base md:text-lg text-white/90 dark:text-[#d0dce6] tracking-tight">
                  Senja introduces a <strong className="text-yellow-300 dark:text-[#60a5fa]">Fee & Buyback Mechanism</strong>, where <strong className="text-yellow-300 dark:text-[#60a5fa]">95% of collected fees</strong> are <strong className="text-yellow-300 dark:text-[#60a5fa]">swapped into KAIA via DragonSwap</strong>, aligning protocol growth with Kaia&apos;s <strong className="text-yellow-300 dark:text-[#60a5fa]">long-term stability</strong>.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-base md:text-lg text-white/90 dark:text-[#d0dce6] tracking-tight">
                  Senja integrates <strong className="text-yellow-300 dark:text-[#60a5fa]">DragonSwap</strong> to allow <strong className="text-yellow-300 dark:text-[#60a5fa]">in-protocol collateral swaps</strong>, giving users more flexibility to manage positions, reduce liquidation risk, and optimize their capital without leaving the platform.
                </p>
              </motion.div>
            </motion.div>
          </Accordion>
