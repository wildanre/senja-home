      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div id="waitlist" className="bg-gradient-to-br from-white via-blue-50/50 to-indigo-50/30 dark:from-slate-800 dark:via-indigo-900/50 dark:to-purple-900/30 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 border border-blue-100/50 dark:border-indigo-800/50 backdrop-blur-sm hover:scale-[1.02] group relative overflow-hidden">
            ...
            <div className="p-8 filter blur-sm relative z-10">
            ...
            {/* Coming Soon Overlay */}
            <div className="absolute inset-0 bg-white/95 dark:bg-slate-800/95 backdrop-blur-sm flex items-center justify-center rounded-2xl">
              <div className="text-center relative z-20">
                <div className="bg-gradient-to-br from-blue-500 to-indigo-600 dark:from-indigo-500 dark:to-purple-600 rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-6 shadow-2xl">
                  <svg 
                ...
                <h4 className="text-xl font-semibold text-gray-700 dark:text-slate-300 mb-3">
                  Coming Soon
                </h4>
